...
export const useFileUpload = (
  ...
  const addFiles = useCallback(
    (newFiles: FileList | File[]) => {
      ...
      if (validFiles.length > 0) {
        ...
        setState((prev) => {
          ...
          return { ...prev, files: newFilesList, errors };
        });
    ...
    [state.files, maxFiles, multiple, maxSize, validateFile, createPreview, generateUniqueId, clearFiles, onFilesChange, onFilesAdded, onError]
  );
