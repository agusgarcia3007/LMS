    ...
    <header className="fixed top-0 z-50 w-full">
      <div className="mx-auto flex max-w-6xl items-center justify-center px-4 pt-4">
        <nav className="relative flex items-center gap-2 px-3 py-2">
          <div
            className={cn(
              "absolute inset-0 rounded-full border border-border/50 bg-background/70 shadow-lg shadow-black/5 backdrop-blur-md transition-all duration-300 ease-out",
              hasScrolled
          ...
          <Link
            ...
            className="relative z-10 flex items-center gap-2 rounded-full px-3 py-1.5 transition-colors hover:bg-foreground/5"
          >
          ...
          <div
            className={cn(
              "relative z-10 mx-1 hidden h-4 w-px transition-opacity duration-300 md:block",
      ...
      {isMenuOpen && (
        <div className="mx-auto mt-2 max-w-md px-4 md:hidden">
          <div className="overflow-hidden rounded-2xl border border-border/50 bg-background/80 shadow-lg backdrop-blur-md">
