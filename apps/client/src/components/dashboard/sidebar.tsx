    ...
    () => [
      ...
      },
      {
        ...
        items: [
          ...
          {
            title: t("conversations.admin.title"),
            url: `/${tenantSlug}/ai/conversations`,
            icon: MessageSquare,
            isActive: currentPath.includes("/ai/conversations"),
          },
        ],
      },
        ...
        ? [
            {
              ...
              items: [
                ...
                },
                {
                  ...
                  url: `/${tenantSlug}/site/integrations`,
                  icon: Key,
                  isActive: currentPath.includes("/site/integrations"),
                },
              ],
            },
          ]
